...
<div class="mainbg-search" id="app">
    <b-container class="bv-example-row">
     ...
     <b-container class="mb-3">
      ...
      <b-col cols="1 centerize">시 :</b-col>
      <b-col cols="3">
        <b-form-select id="sido2" v-model="SidoCode2" @change="getGugunCode">
          <option v-for="(option, index) in sido" :key="index" :value="option.sido_code">
            {{ option.sido_name }}
          </option>
        </b-form-select>
      ...
      <b-col cols="1 centerize">구 군 :</b-col>
      <b-col cols="3">
        <b-form-select id="gugun2" v-model="GugunCode2" @change="getDongCode">
          <option v-for="(option, index) in gugun" :key="index" :value="option.gugun_code">
            {{ option.gugun_name }}
          </option>
        </b-form-select>
      ...
      <b-col cols="1 centerize">동 :</b-col>
      <b-col cols="3">
        <b-form-select id="dong2" v-model="Dong2" @change="getAptName">
          <option v-for="(option, index) in dong" :key="index" :value="option.dong">
            {{ option.dong }}
          </option>
        </b-form-select>
